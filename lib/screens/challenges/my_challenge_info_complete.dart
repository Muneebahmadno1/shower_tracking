...
class MyChallengeInfoComplete extends StatefulWidget {
  MyChallengeInfoComplete({Key? key, required this.index}) : super(key: key);
  int index;
  @override
  State<MyChallengeInfoComplete> createState() =>
      _MyChallengeInfoCompleteState();
}

class _MyChallengeInfoCompleteState extends State<MyChallengeInfoComplete> {
    ...
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              for (int i = 0;
                ...
                RectangleBox.myChallengeInfoRectangleBox(
                  context: context,
                  color: _challengeController.challenges[widget.index]
      ...
      bottomNavigationBar: Container(
        ...
        child: RectangleBox.roundText(
          context: context,
          text: "This challenge is complete",
          color: HexColor('#FFA0A0'),
        ),
      ),
    );
  }
